  ...
  <div class="theme-box min-h-screen flex flex-col">
    <nav class="fixed top-0 left-0 right-0 z-50 h-20 flex items-center justify-center">
      <div class="theme-menu backdrop-brightness-125 backdrop-blur-xl shadow-xl flex items-center lg:space-x-8 space-x-6 lg:px-8 px-6 py-2 rounded-2xl max-w-max">
        <div class="2xl:text-4xl xl:text-4xl lg:text-3xl md:text-3xl sm:text-2xl text-2xl font-[Stardom] font-bold">
          <NuxtLink to="/">notetake</NuxtLink>
        </div>
        <ul class="flex lg:space-x-6 space-x-4 items-center 2xl:text-lg xl:text-lg lg:text-base md:text-base sm:text-sm text-sm font-[Satoshi] font-bold">
          <li>
            <button
              class="flex flex-row items-center gap-1 p-1 px-3 rounded-lg hover:bg-white/10 cursor-pointer"
